...
class User {
	...
	public function __construct($user = null){
		...
		if(!$user){
			if(Session::exists($this->_sessionName)){
				/*Secong parameter in session get set to true for decrypting, default is false.*/
				$user = Session::get($this->_sessionName, true);
	...
	public function login($username = null, $password = null, $remember = false){
		...
		if(!$username && !$password && $this->exists()){
			Session::put($this->_sessionName, $this->data()->id, true);
		} else {
